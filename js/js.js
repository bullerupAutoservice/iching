...
function getChanges() {
  ...
  if (changing_lines === 0) {
    changing_desc.innerHTML += 'No changing lines! Only the cast hexagram applies! This signifies that conditions related to your topic are relatively stable or not in great flux at this particular time'
